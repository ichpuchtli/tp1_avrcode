...
struct AVRTime_t {
    ...
    volatile uint16_t months;       // 0 <=> 65535 % 12
    volatile uint16_t days;         // 0 <=> 65535 % 365
    volatile uint16_t hours;        // 0 <=> 65535 % 24
    volatile uint16_t minutes;      // 0 <=> 65535 % 60
    volatile uint16_t seconds;      // 0 <=> 65535 % 60
};
